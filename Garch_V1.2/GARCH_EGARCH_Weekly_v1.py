...
#    print(model.summary())
    ...
    test = data0[segmentlength+1:-1]
    testb = data1[segmentlength+1:-1]
    ...
    model = GARCH_model(train, 'EGARCH', pval1, qval1, pval1)
    model1 = GARCH_model(train, 'GARCH', pval1, qval1, pval1)
    
    modelb = GARCH_model(train, 'EGARCH', pval1, qval1, pval1)
    model1b = GARCH_model(train, 'GARCH', pval1, qval1, pval1)
    ...
    scale1 = model_fit1.scale
    scaleb = model_fitb.scale
    scale1b = model_fit1b.scale
    ...
    print('yhat',yhat)
    yhat1 = model_fit1.forecast(horizon=segmentlength, method="simulation")
    print('yhat',yhat1)
    yhatb = model_fitb.forecast(horizon=segmentlength, method="simulation")
    print('yhat',yhatb)
    yhat1b = model_fit1b.forecast(horizon=segmentlength, method="simulation")
    print('yhat',yhat1b)
    ...
    yhat_plot=plt.plot(yhat.residual_variance, label='Residual Variance EGARCH', color='b')
    yhat_plot=plt.plot(yhat1.residual_variance, label='Residual Variance GARCH', color='g')

    curvar1 = yhat.variance.values/scale
    curvar1g = yhat1.variance.values/scale1
    curvarb = yhatb.variance.values/scaleb
    curvar1bg = yhat1b.variance.values/scale1b
